...
<style>
body{
  background-image: url('../Imgs/editbg10.jpg');
  background-repeat: no-repeat;
  background-attachment: fixed;
  background-size: 100% 100%;
}
</style>
<link rel="stylesheet" href="../greenCSS/addNewProduct-style.css">
...
<%
	...
	try
	{
		...
		ResultSet rs=st.executeQuery("select id,name,category,price,quantity from allmedicines where id='"+id+"'");
		while (rs.next())
		{
