...
<html>
<head>
<link rel="stylesheet" href="greenCSS/orderReceived.css">
<title>Home</title>
<style>
.th-style
{ width: 25%;}
...
<%
 ...
 ResultSet rs=st.executeQuery("select * from cart inner join allmedicines where cart.pid=allmedicines.id and cart.orderDate is not NULL and cart.status='processing'");
 while(rs.next()){
%>
