...
<%
	...
	try
	{
		...
		PreparedStatement ps=con.prepareStatement("select * from cart inner join allmedicines   where  cart.pid=allmedicines.id  and  cart.email='"+email+"' and cart.orderDate is not NULL");
