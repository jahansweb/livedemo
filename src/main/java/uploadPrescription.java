...
public class uploadPrescription extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		String uploadPath="D:/myFinalProject/greenpharmacyproject/src/main/webapp/prescriptions/"+imageFileName;  // upload path where we have to upload our actual image
		...
		try 
		{
			...
			String query="insert into prescription(imageFileName) values(?)";
			...
			if(row>0)
			{
				response.sendRedirect("presUploadSuccess.jsp");
			}
